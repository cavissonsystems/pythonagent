...
from agent.probes.instrumentation import EntryPointProbe


class WSGIProbe(EntryPointProbe):
    def attach(self, application):
        super(WSGIProbe, self).attach(application, patched_method_name='application_callable')
...
class WSGIMiddleware(object):
    def __init__(self, application=None):
        ...
        self._interceptor = WSGIProbe(appdynamics.agent.get_agent_instance(), None)
