...
"""Probing appd_cx_oracle package.
...
class CxOracleConnectionProbe(DbAPIConnectionProbe):
    def get_backend_properties(self, conn, *args, **kwargs):
        return parse_oracle_dsn(*args, **kwargs) + ('ORACLE',)


class CxOracleCursorProbe(DbAPICursorProbe):
    def get_connection(self, cursor):
        return cursor.connection


def probe_cx_oracle_connection(agent, mod):
    ...
    CxOracleConnectionProbe(agent, mod.Connection, CxOracleCursorProbe).attach('__init__')
