...
class HttplibConnectionProbe(HTTPConnectionProbe):
...
def probe_httplib(agent, mod):
    HTTPConnectionProbe.https_connection_classes.add(mod.HTTPSConnection)
    probe = HttplibConnectionProbe(agent, mod.HTTPConnection)
    probe.attach(['putrequest', 'endheaders'])
    probe.attach('getresponse', wrapper_func=None)   # CORE-40945 Do not wrap getresponse in the default wrapper.
